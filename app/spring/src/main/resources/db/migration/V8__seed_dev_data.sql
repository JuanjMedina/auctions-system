...
--
-- Prefijos UUID (todos hexadecimales válidos 0-9 a-f):
--   a0... → users
--   b0... → bids
--   c0... → categories
--   d0... → wallets
--   e0... → auctions
--   f0... → wallet_transactions
-- =============================================================================
...
VALUES
    ('d0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001',    0.0000,   0.0000, 'USD', 0),
    ('d0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002',  650.0000,   0.0000, 'USD', 2),
    ('d0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000003',  500.0000,   0.0000, 'USD', 0),
    ('d0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000004',  850.0000,   0.0000, 'USD', 1),
    ('d0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000005', 1000.0000, 200.0000, 'USD', 1),
    ('d0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000006', 1000.0000,   0.0000, 'USD', 0);

-- -----------------------------------------------------------------------------
-- WALLET TRANSACTIONS  (prefijo f0...)
-- -----------------------------------------------------------------------------
INSERT INTO wallet_transactions (id, wallet_id, reference_id, type, amount, balance_after, description, created_at)
VALUES
    -- seller1 recibió payout de la subasta awarded
    ('f0000000-0000-0000-0000-000000000001',
     'd0000000-0000-0000-0000-000000000002',
     'e0000000-0000-0000-0000-000000000005',
     'AUCTION_PAYOUT', 150.0000, 650.0000, 'Auction payout received', NOW() - INTERVAL '2 hours'),

    -- buyer1 depósito inicial
    ('f0000000-0000-0000-0000-000000000002',
     'd0000000-0000-0000-0000-000000000004',
     NULL,
     'DEPOSIT', 1000.0000, 1000.0000, 'Depósito inicial', NOW() - INTERVAL '3 days'),

    -- buyer1 fue cobrado al ganar la subasta awarded
    ('f0000000-0000-0000-0000-000000000003',
     'd0000000-0000-0000-0000-000000000004',
     'e0000000-0000-0000-0000-000000000005',
     'AUCTION_CHARGE', 150.0000, 850.0000, 'Auction winning charge', NOW() - INTERVAL '2 hours'),
    ...
    ('f0000000-0000-0000-0000-000000000005',
     ...
     'BID_RESERVE', 200.0000, 1000.0000, 'Funds reserved for bid', NOW() - INTERVAL '30 minutes');
...
VALUES
    ...
    ('e0000000-0000-0000-0000-000000000001',
     ...
     'iPhone 15 Pro - Sin Publicar',
     'iPhone 15 Pro 256GB Titanio Negro, caja sellada.',
    ...
    -- 3. ACTIVE — activa sin pujas
    ('e0000000-0000-0000-0000-000000000003',
     'a0000000-0000-0000-0000-000000000003',
     'c0000000-0000-0000-0000-000000000004',
     'Cuadro Original — Óleo sobre Lienzo',
     'Pintura original al óleo 60x80cm firmada por el artista.',
    ...
    ('e0000000-0000-0000-0000-000000000004',
     ...
     'Samsung Galaxy S24 Ultra 512GB Phantom Black, libre de fábrica.',
    ...
    ('e0000000-0000-0000-0000-000000000005',
     ...
     'Chaqueta Vintage Levi''s 90s',
     'Chaqueta de jean Levi''s original de los 90s, talla M, excelente estado.',
    ...
    ('e0000000-0000-0000-0000-000000000006',
     ...
     'PlayStation 5 Digital Edition, con 2 mandos, en caja.',
    ...
    ('e0000000-0000-0000-0000-000000000007',
     ...
     'Lenovo Tab P12 12.7" 256GB, con teclado y stylus.',
...
VALUES
    -- Subasta activa (e...004): buyer1 pujó $150 → fue superado (OUTBID)
